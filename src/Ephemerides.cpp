...
static SphereVector transformRectToEcliptic(RectVector p);
static SphereVector transformRectToEquatorial(RectVector p);
static RectVector rotateVectorEclToEqu(RectVector p);
...
PlanetData getPlanetData(double jd) {
    double t=(jd - 2451545.0) / 365250.0; //from https://celestialprogramming.com/vsop87-multilang/index.html
    RectVector earth_position_sun = {.x = earth_x(t), .y = earth_y(t), .z = earth_z(t)};
    RectVector emb_position_sun = {.x = emb_x(t), .y = emb_y(t), .z = emb_z(t)};
    RectVector mercury_position_sun = {.x = mercury_x(t), .y = mercury_y(t), .z = mercury_z(t)};
    RectVector venus_position_sun = {.x = venus_x(t), .y = venus_y(t), .z = venus_z(t)};
    RectVector mars_position_sun = {.x = mars_x(t), .y = mars_y(t), .z = mars_z(t)};
    RectVector jupiter_position_sun = {.x = jupiter_x(t), .y = jupiter_y(t), .z = jupiter_z(t)};
    RectVector saturn_position_sun = {.x = saturn_x(t), .y = saturn_y(t), .z = saturn_z(t)};

    RectVector sun_position_earth = getNegativeVector(earth_position_sun);
    RectVector emb_position_earth = addVectors(emb_position_sun, sun_position_earth);
    RectVector mercury_position_earth = addVectors(mercury_position_sun, sun_position_earth);
    RectVector venus_position_earth = addVectors(venus_position_sun, sun_position_earth);
    RectVector mars_position_earth = addVectors(mars_position_sun, sun_position_earth);
    RectVector jupiter_position_earth = addVectors(jupiter_position_sun, sun_position_earth);
    RectVector saturn_position_earth = addVectors(saturn_position_sun, sun_position_earth);


    PlanetData data = {
        .sun_ecl_latlong = transformRectToEcliptic(sun_position_earth), 
        .moon_ecl_latlong = transformRectToEcliptic(emb_position_earth),
        .mercury_ecl_latlong = transformRectToEcliptic(mercury_position_earth),
        .venus_ecl_latlong = transformRectToEcliptic(venus_position_earth),
        .mars_ecl_latlong = transformRectToEcliptic(mars_position_earth),
        .jupiter_ecl_latlong = transformRectToEcliptic(jupiter_position_earth),
        .saturn_ecl_latlong = transformRectToEcliptic(saturn_position_earth),
        .sun_equ_latlong = transformRectToEquatorial(sun_position_earth),
        .moon_equ_latlong = transformRectToEquatorial(emb_position_earth),
        .mercury_equ_latlong = transformRectToEquatorial(mercury_position_earth),
        .venus_equ_latlong = transformRectToEquatorial(venus_position_earth),
        .mars_equ_latlong = transformRectToEquatorial(mars_position_earth),
        .jupiter_equ_latlong = transformRectToEquatorial(jupiter_position_earth),
        .saturn_equ_latlong = transformRectToEquatorial(saturn_position_earth)
    };
...
static SphereVector transformRectToEcliptic(RectVector p) {
    return getLatLongFromRect(p);
}

static SphereVector transformRectToEquatorial(RectVector p) {
    RectVector p_equ = rotateVectorEclToEqu(p);
    return getLatLongFromRect(p_equ);

}

static RectVector rotateVectorEclToEqu(RectVector p) {
   return rotateVectorAboutX(p, e);
}

//earth and emb are from vsop87a_small
//jupiter and saturn are from vsop87a_nano
//mercury, venus, and mars are from vsop87a_micro
